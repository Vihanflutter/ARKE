              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="HALF_DAY">Half Day (Auto-resolve)</option>
                    <option value="HALF_DAY_1">Half Day 1 (Before 3:00 PM)</option>
                    <option value="HALF_DAY_2">Half Day 2 (After 3:00 PM)</option>
